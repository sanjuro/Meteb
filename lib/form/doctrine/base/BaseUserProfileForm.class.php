...
abstract class BaseUserProfileForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'spouse_gender_id'   => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'fund_code_id'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('FundCode'), 'required' => false)),
      ...
      'token'              => new sfValidatorString(array('max_length' => 30, 'required' => false)),
      ...
      'spouse_gender_id'   => new sfValidatorInteger(array('required' => false)),
