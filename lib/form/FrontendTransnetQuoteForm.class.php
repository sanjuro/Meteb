...
/**
 * FrontendTransnetQuoteForm form, extends the base quote form renames some labels.
 * Also sets the created by field using the logged in user
 *
 * @package    meteb
 * @subpackage Frontend Transnet Quote form
...
class FrontendTransnetQuoteForm extends BaseQuoteForm
{
  ...
  public function configure()
  {
	...
	$this->widgetSchema['gp'] = new sfWidgetFormChoice(
	     	array( 'label' => 'Guarantee Period', 'choices' => array( '' => 'Select a Guarantee Period', 0 => '0 months', 60 => '60 months', 84 => '84 months', 120 => '120 months', 184 => '184 months',)));
	...
	$this->widgetSchema['commission_id'] = new sfWidgetFormInputHidden();  
	...
	$this->validatorSchema['main_sex'] = new sfValidatorDoctrineChoice(array('multiple' => false, 'model' => 'Gender', 'min' => 1), array('required' => 'Please select a valid Main Member\'s Gender'));
