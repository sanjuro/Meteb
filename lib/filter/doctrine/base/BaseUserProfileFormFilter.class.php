...
abstract class BaseUserProfileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'parent_user_profile_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'parent_user_profile_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
