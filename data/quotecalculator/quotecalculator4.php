<?php
	...
	generate_quote($_POST[commission], $_POST[main_sex], $_POST[main_dob], $_POST[second_life], $_POST[spouse_sex], $_POST[spouse_dob], $_POST[gp], $_POST[spouse_rev], $_POST[pp]*0,10000,$quote_out);

	echo "<br>quote_number: ".$quote_out["quote_number"];
