...
CREATE TABLE commission (id BIGINT AUTO_INCREMENT, value DECIMAL(15, 2), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE mortality_rate (id BIGINT AUTO_INCREMENT, age BIGINT, mortality_male DECIMAL(10, 5), mortality_female DECIMAL(10, 5), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE pri (id BIGINT AUTO_INCREMENT, value DECIMAL(15, 3), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE spouse_reversion (id BIGINT AUTO_INCREMENT, value DECIMAL(15, 2), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE system (id BIGINT AUTO_INCREMENT, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE tax_rate (id BIGINT AUTO_INCREMENT, tax_rate DECIMAL(10, 5), start_bracket DECIMAL(10, 5), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE user_profile (id BIGINT AUTO_INCREMENT, sfuser_id BIGINT, gender_id BIGINT, spouse_gender_id BIGINT, status_id BIGINT, parent_user_id BIGINT, fsp_license_number VARCHAR(12), title VARCHAR(30), name VARCHAR(30) NOT NULL, surname VARCHAR(30) NOT NULL, dob DATE NOT NULL, telephone VARCHAR(20) NOT NULL, mobile VARCHAR(20) NOT NULL, idnumber VARCHAR(20) NOT NULL, fax VARCHAR(20) NOT NULL, postaladdress VARCHAR(100) NOT NULL, streetaddress VARCHAR(100) NOT NULL, spouse_name VARCHAR(30) NOT NULL, spouse_surname VARCHAR(30) NOT NULL, spouse_dob DATE, spouseidnumber VARCHAR(20) NOT NULL, company VARCHAR(30) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX sfuser_id_idx (sfuser_id), INDEX gender_id_idx (gender_id), INDEX spouse_gender_id_idx (spouse_gender_id), INDEX status_id_idx (status_id), INDEX parent_user_id_idx (parent_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
