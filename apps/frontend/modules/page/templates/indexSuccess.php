...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You can <span style="color:red;"><?php echo link_to('click here', url_for('@page_toolbox')) ?></span> to read more about annuity investments and what advantages they can offer to you.<br> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Look at all the options you can select for your annuity and see how they affect your quote by clicking <?php echo link_to('here', url_for('@page_toolbox')) ?>.<br>
