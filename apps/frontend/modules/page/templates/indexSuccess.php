...
<p>We provide online annuity quotations for individuals who are close to retirement.<br>
...
<ul>
<li>You can <span style="color:red;"><?php echo link_to('click here', url_for('@page_annuityexplained')) ?></span> to read more about annuity investments and what advantages they can offer to you.</li> 
<li>Look at all the options you can select for your annuity and see how they affect your quote by clicking <?php echo link_to('here', url_for('@page_annuityoptions')) ?>.</li>
<li>View the historical increases that have been awarded and download product brochures <?php echo link_to('here', url_for('@page_downloads')) ?>.</li>
</ul>
</div>
<br>
