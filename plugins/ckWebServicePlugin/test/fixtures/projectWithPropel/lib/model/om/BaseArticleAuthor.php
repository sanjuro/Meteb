...
/**
 * Base class that represents a row from the 'article_author' table.
 *
 * 
 *
 ...
 */
abstract class BaseArticleAuthor extends BaseObject  implements Persistent {
	 ...
	 * @return     ArticleAuthor The current object (for fluent API support)
	 */
	public function setArticleId($v)
	{
		...
		if ($this->article_id !== $v) {
			$this->article_id = $v;
			$this->modifiedColumns[] = ArticleAuthorPeer::ARTICLE_ID;
		}
	...
	public function setAuthorId($v)
	{
		...
		if ($this->author_id !== $v) {
			$this->author_id = $v;
			$this->modifiedColumns[] = ArticleAuthorPeer::AUTHOR_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ArticleAuthorPeer::NUM_COLUMNS - ArticleAuthorPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArticleAuthor object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArticleAuthorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseArticleAuthor:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ArticleAuthorPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseArticleAuthor:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseArticleAuthor:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseArticleAuthor:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				ArticleAuthorPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArticleAuthorPeer::doInsert($this, $con);
					...
					$affectedRows += ArticleAuthorPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArticleAuthorPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArticleAuthorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticleAuthorPeer::ARTICLE_ID)) $criteria->add(ArticleAuthorPeer::ARTICLE_ID, $this->article_id);
		if ($this->isColumnModified(ArticleAuthorPeer::AUTHOR_ID)) $criteria->add(ArticleAuthorPeer::AUTHOR_ID, $this->author_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArticleAuthorPeer::ARTICLE_ID, $this->article_id);
		$criteria->add(ArticleAuthorPeer::AUTHOR_ID, $this->author_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArticleAuthor (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArticleAuthor Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArticleAuthorPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArticleAuthorPeer();
		}
		return self::$peer;
	}
	...
	public function getArticle(PropelPDO $con = null)
	{
		if ($this->aArticle === null && ($this->article_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArticle->addArticleAuthors($this);
			 */
		}
	...
	public function getAuthor(PropelPDO $con = null)
	{
		if ($this->aAuthor === null && ($this->author_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAuthor->addArticleAuthors($this);
			 */
		}
		return $this->aAuthor;
	}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseArticleAuthor:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseArticleAuthor::%s', $method));
	  }
