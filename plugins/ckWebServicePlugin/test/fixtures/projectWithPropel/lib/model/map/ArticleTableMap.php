...
class ArticleTableMap extends TableMap {
	...
	{
    $this->addRelation('ArticleComment', 'ArticleComment', RelationMap::ONE_TO_MANY, array('id' => 'article_id', ), null, null);
    $this->addRelation('ArticleAuthor', 'ArticleAuthor', RelationMap::ONE_TO_MANY, array('id' => 'article_id', ), null, null);
	} // buildRelations()
